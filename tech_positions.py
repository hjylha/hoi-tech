...
tech_positions = {
    ...
    # main battle tank
    7500: (left1_x - 0.02, 0.085),
    7510: (left1_x - 0.02, 0.05),
    7520: (left2_x - 0.05, 0.067),
    7530: (left2_x - 0.05, 0.032),

    # flying bomb -- icbm
    7340: (left3_x - 0.01, 0.9),
    7350: (left3_x, 0.81),
    7360: (left3_x + 0.01, 0.72),
    7370: (left3_x + 0.01, 0.685),
    # space recon
    7570: (left3_x + 0.01, 0.65),

    # turbojet fighter
    7380: (left3_x - 0.01, 0.49),
    7390: (left3_x, 0.455),

    # air cavalry
    7400: (left4_x - 0.02, 0.2),

    # electronic computers
    7410: (left3_x - 0.01, 0.34),
    7420: (left3_x - 0.01, 0.305),
    7430: (left3_x - 0.01, 0.27),
    7440: (left3_x - 0.01, 0.235),

    # radar
    7540: (left3_x - 0.01, 0.12),
    7550: (left3_x, 0.085),
    7560: (left3_x + 0.01, 0.05),

    # satellites
    7460: (left4_x - 0.02, 0.9),
    7470: (left4_x - 0.01, 0.865),
    7480: (left4_x, 0.83),
    7490: (left4_x + 0.01, 0.795),

    # more missiles
    7610: (left4_x + 0.01, 0.63),
    7620: (left4_x + 0.01, 0.595),
    7630: (left4_x + 0.01, 0.56),

    # submarines
    7580: (left4_x + 0.01, 0.4),
    7590: (left4_x + 0.01, 0.365),
    7600: (left4_x + 0.01, 0.33),
