...
def test_change_type_if_necessary(text, result):
    assert rf.change_type_if_necessary(text) == result
...
def test_get_first_item_from_text(text, first_item, the_rest):
    assert rf.get_first_item_from_text(text) == (first_item, the_rest)

def test_get_first_item_from_text_iterative():
    full_line = "{1 2 3 4}"
    item0, line0 = rf.get_first_item_from_text(full_line)
    assert item0 == "{"
    assert line0 == "1 2 3 4}"
    item1, line1 = rf.get_first_item_from_text(line0)
    assert item1 == 1
    assert line1 == "2 3 4}"
    item2, line2 = rf.get_first_item_from_text(line1)
    assert item2 == 2
    assert line2 == "3 4}"
    item3, line3 = rf.get_first_item_from_text(line2)
    assert item3 == 3
    assert line3 == "4}"
    item4, line4 = rf.get_first_item_from_text(line3)
    assert item4 == 4
    assert line4 == "}"
...
def test_get_first_item_from_text_iterative2():
    ...
    assert item4 == "="
    assert line4 == "1"
    item5, line5 = rf.get_first_item_from_text(line4)
    assert item5 == 1
    assert line5 == ""
...
#     content = rf.read_txt_file0(test_txt_file_path)
...
def test_read_txt_file0(text_encoding, txt_file_content0):
    test_txt_file_path = Path(__file__).parent / "txt_file_for_testing0.txt"
    assert test_txt_file_path.exists()
    content = rf.read_txt_file(test_txt_file_path, text_encoding)
    assert isinstance(content, dict)
    assert content == txt_file_content0


def test_read_txt_file1(text_encoding, txt_file_content1):
    test_txt_file_path = Path(__file__).parent / "txt_file_for_testing1.txt"
    assert test_txt_file_path.exists()
    content = rf.read_txt_file(test_txt_file_path, text_encoding)
    assert isinstance(content, dict)
...
def test_read_txt_file2(text_encoding, txt_file_content2):
    test_txt_file_path = Path(__file__).parent / "txt_file_for_testing2.txt"
    assert test_txt_file_path.exists()
    content = rf.read_txt_file(test_txt_file_path, text_encoding)
    assert isinstance(content, dict)
...
def test_read_txt_file3(text_encoding, txt_file_content3):
    test_txt_file_path = Path(__file__).parent / "txt_file_for_testing3.txt"
    assert test_txt_file_path.exists()
    content = rf.read_txt_file(test_txt_file_path, text_encoding)
    assert isinstance(content, dict)
...
def test_read_txt_file_list0(text_encoding, txt_file_content_list0):
    test_txt_file_path = Path(__file__).parent / "txt_file_for_testing_list0.txt"
    assert test_txt_file_path.exists()
    content = rf.read_txt_file(test_txt_file_path, text_encoding)
    assert isinstance(content, list)
...
def test_read_txt_file_list1(text_encoding, txt_file_content_list1):
    test_txt_file_path = Path(__file__).parent / "txt_file_for_testing_list1.txt"
    assert test_txt_file_path.exists()
    content = rf.read_txt_file(test_txt_file_path, text_encoding)
    assert isinstance(content, list)
...
def test_read_txt_file_list2(text_encoding, txt_file_content_list2):
