...
def get_techs_for_testing():
	...
	techs_for_testing[3330] = Tech(3330, 'Coastal Submarine', 'Coastal', 'naval', [3320], components, effects)
	...
	techs_for_testing[1670] = Tech(1670, 'Electronic Warfare', 'Electronic Warfare', 'infantry', [], components, effects)
	...
	techs_for_testing[3720] = Tech(3720, 'Landing Craft Support', 'Landing Craft Sup', 'naval', [], components, effects)
	...
	techs_for_testing[4370] = Tech(4370, 'Basic Strategic Bomber', 'Basic Strat. Bomber', 'aircraft', [4230], components, effects)
	...
	techs_for_testing[2070] = Tech(2070, 'Light Tank Prototypes', 'Light Prototypes', 'armor', [2010], components, effects)
	...
	techs_for_testing[6680] = Tech(6680, 'Small Units Doctrine', 'Small Units', 'land_doctrines', [], components, effects)
	...
	techs_for_testing[4520] = Tech(4520, 'Jet Engine Concepts', 'Jet Concepts', 'aircraft', [], components, effects)
	...
	techs_for_testing[7210] = Tech(7210, 'Nuclear Carrier Vessel Propulsion', 'Nuclear Carrier', 'secret_weapons', [3560, 7140], components, effects)
	...
	techs_for_testing[9010] = Tech(9010, 'Air Power Doctrine', 'Air Power', 'air_doctrines', [], components, effects)
	...
	techs_for_testing[2610] = Tech(2610, 'Self-Propelled Rocket Artillery Prototypes', 'Self-Prop. Rocket', 'armor', [2570, 2090], components, effects)
	...
	techs_for_testing[4020] = Tech(4020, 'Interceptor/Fighter Prototypes', 'Int./Fighter Prototypes', 'aircraft', [4010], components, effects)
	...
	techs_for_testing[1080] = Tech(1080, 'Post-WWI Infantry', 'Post-WWI', 'infantry', [1070], components, effects)
	...
	techs_for_testing[4280] = Tech(4280, 'Basic Air Transport', 'Basic Air Transport', 'aircraft', [4230], components, effects)
	...
	techs_for_testing[4670] = Tech(4670, 'Light Surveillance Aircraft', 'Light Surveillance', 'aircraft', [], components, effects)
	...
	techs_for_testing[4030] = Tech(4030, 'Basic Fighter', 'Basic Fighter', 'aircraft', [4020], components, effects)
	...
	techs_for_testing[5440] = Tech(5440, 'Study Centers', 'Study Centers', 'industry', [], components, effects)
	...
	techs_for_testing[4550] = Tech(4550, 'Standard Jet Engine', 'Standard Engine', 'aircraft', [4540, 5070], components, effects)
	...
	techs_for_testing[8020] = Tech(8020, 'Sea Control Doctrine', 'Sea Control', 'naval_doctrines', [8010], components, effects)
	...
	techs_for_testing[2650] = Tech(2650, 'Prioritize Speed', 'Prioritize Speed', 'armor', [], components, effects)
	...
	techs_for_testing[1630] = Tech(1630, 'Commando Units', 'Commando Units', 'infantry', [], components, effects)
	...
	techs_for_testing[2530] = Tech(2530, 'Armoured Car Prototypes', 'Armoured Car', 'armor', [], components, effects)
	...
	techs_for_testing[8680] = Tech(8680, 'Naval Intelligence Doctrine', 'Naval Intelligence', 'naval_doctrines', [], components, effects)
	...
	techs_for_testing[7150] = Tech(7150, 'Nuclear Waste Bomb', 'Nuclear Waste Bomb', 'secret_weapons', [7140], components, effects)
	...
	techs_for_testing[2290] = Tech(2290, 'Heavy Anti-Air Prototypes', 'Heavy Anti-Air', 'armor', [2010], components, effects)
	...
	techs_for_testing[1010] = Tech(1010, 'Basic Sub-Machine Gun', 'Basic SMG', 'infantry', [], components, effects)
	...
	techs_for_testing[6770] = Tech(6770, 'Patrols Doctrine', 'Patrols', 'land_doctrines', [6690], components, effects)
	...
	techs_for_testing[2680] = Tech(2680, 'Basic Mechanical Components', 'Basic Mechanical', 'armor', [], components, effects)
